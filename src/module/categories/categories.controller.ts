...
export class CategoriesController {
  ...
  @Post()
  @ApiOperation({ summary: 'Create category', description: 'Create a new product category' })
  ...
  @Get('flat')
  @ApiOperation({ summary: 'Get flat categories list', description: 'Get a simplified list of all categories without hierarchy' })
  ...
  @Get('stats')
  @ApiOperation({ summary: 'Get categories statistics', description: 'Get statistical information about categories' })
  ...
  @ApiQuery({ name: 'name', type: 'string', required: true, description: 'Category name to search for' })
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get category by ID', description: 'Retrieve a specific category' })
  ...
  @Patch(':id/restore')
  @ApiOperation({ summary: 'Restore deleted category', description: 'Restore a previously deleted category' })
  @ApiParam({ name: 'id', type: 'string', description: 'Category UUID' })
